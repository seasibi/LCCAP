...
const WaterSufficiency = () => {
  ...
  const calculateProjectsFromEvents = (eventsData) => {
    const waterSufficiencyEvents = eventsData.filter(event => 
      event.pillar && event.pillar.includes('Water Sufficiency')
    );
    
    // Group events by office to create projects
    const officeGroups = waterSufficiencyEvents.reduce((acc, event) => {
    ...
    const loadEvents = async () => {
      try {
        ...
        setEvents([
          {
            id: 1,
            event_name: 'Water Supply Expansion',
            date: '2026-03-15',
            duration: '3 days',
          ...
          {
            id: 2,
            event_name: 'Water Treatment Plant Upgrade',
            date: '2026-03-20',
            duration: '1 week',
            pillar: '2. Water Sufficiency',
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className={getTextClass('pageTitle')}>Water Sufficiency</h1>
        ...
        <div className={getStatisticsCardClasses('accomplishment')}>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-900">{stats.overallAccomplishment}%</p>
            </div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={handleAdd}
          className={getPillarButtonClasses('Water Sufficiency')}
        >
