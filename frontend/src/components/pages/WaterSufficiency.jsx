...
const WaterSufficiency = () => {
  ...
  const [projects, setProjects] = useState([
    {
      id: 1,
      office: 'City Waterworks Office',
      projectName: 'Water Supply Expansion',
      accomplishment: 78,
      status: 'Ongoing',
      target: '500 households',
      actual: '390 households',
      quarter: 'Q1 2026'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      projectName: 'Watershed Protection',
      accomplishment: 92,
      status: 'Ongoing',
      target: '1000 hectares',
      actual: '920 hectares protected',
      quarter: 'Q1 2026'
    }
  ]);
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Water Sufficiency</h1>
        <p className="text-gray-600">Programs and projects ensuring adequate water supply and sustainable water management</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg shadow-md p-6 border border-cyan-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-cyan-700 font-medium">Overall Accomplishment</p>
              <p className="text-2xl font-bold text-cyan-900">{stats.overallAccomplishment}%</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg shadow-md p-6 border border-indigo-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-indigo-700 font-medium">Total Departments</p>
              <p className="text-2xl font-bold text-indigo-900">{stats.totalDepartments}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-md p-6 border border-teal-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-teal-700 font-medium">Total Projects</p>
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 m-4 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{selectedProject.office}</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-sm text-gray-500">Accomplishment</p>
                <p className="font-medium">{selectedProject.accomplishment}%</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-medium">{selectedProject.target}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Actual</p>
                <p className="font-medium">{selectedProject.actual}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Quarter</p>
                <p className="font-medium">{selectedProject.quarter}</p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option>City Waterworks Office</option>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Accomplishment (%)</label>
                  <input type="number" min="0" max="100" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
                <div>
...
export default WaterSufficiency;
