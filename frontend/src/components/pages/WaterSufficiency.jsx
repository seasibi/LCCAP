  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 p-6 md:p-8">
      <GoalHeader 
        ...
        subtitle={
          <>
            Ensure comprehensive review and restructuring of the entire water sector, assessing the resilience of major water resources and infrastructure, managing water supply and demand, and improving water quality while promoting conservation.
          </>
        }
      />
