...
const EcologicalStability = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Ecological and Environmental Stability</h1>
        <p className="text-gray-600">Programs protecting natural ecosystems and environmental sustainability</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-md p-6 border border-teal-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-teal-700 font-medium">Total Departments</p>
              <p className="text-2xl font-bold text-teal-900">{stats.totalDepartments}</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-lime-50 to-lime-100 rounded-lg shadow-md p-6 border border-lime-300">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-lime-700 font-medium">Total Projects</p>
              <p className="text-2xl font-bold text-lime-900">{stats.totalProjects}</p>
            </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="flex-1 bg-gray-200 rounded-full h-2 mr-3">
                        <div className="bg-green-600 h-2 rounded-full" style={{ width: `${project.accomplishment}%` }}></div>
                      </div>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="number" min="0" max="100" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" />
                </div>
                <div>
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <button type="submit" className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">{isEditModalOpen ? 'Update' : 'Save'}</button>
              </div>
            </form>
          </div>
        </div>
