  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 p-6 md:p-8">
      <GoalHeader 
        ...
        subtitle="Ensures on the promotion and development of renewable energy, energy efficiency and conservation, and sustainable transport."
      />
      ...
      <div className="bg-white border border-green-100 rounded-2xl p-6 mb-8 shadow-lg">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          <div>
            ...
            <p className="text-sm text-gray-600">Manage and track sustainable energy initiatives</p>
          </div>
          <button
            onClick={handleAdd}
