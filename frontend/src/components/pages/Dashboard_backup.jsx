  ...
  return (
    <div className="p-6 h-screen overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Right Side - Statistics Cards (1/2 width) */}
        <div className="flex-1">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg shadow-md p-6 border border-amber-300">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-amber-900">{getEventStatistics().ongoingEvents}</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg shadow-md p-6 border border-red-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-red-700 font-medium">Moved</p>
                  <p className="text-3xl font-bold text-red-900">{getEventStatistics().movedEvents}</p>
                </div>
            ...
            {/* Planned Events Card */}
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg shadow-md p-6 border border-gray-300">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-700 font-medium">Planned</p>
                  <p className="text-3xl font-bold text-gray-900">{getEventStatistics().plannedEvents}</p>
                </div>
